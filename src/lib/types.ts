export type DemandStatus = 'aguardando_cliente' | 'documentos_parciais' | 'documentos_em_analise' | 'em_andamento' | 'pendencia' | 'previa_enviada' | 'previa_aprovada' | 'finalizado' | 'impedida' | 'reaberta' | 'dispensada';
