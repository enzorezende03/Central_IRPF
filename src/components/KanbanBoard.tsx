...
const COLUMN_LABELS: Record<KanbanColumn, string> = {
  ...
  declaracao_em_preenchimento: STATUS_LABELS.declaracao_em_preenchimento,
...
const columnColors: Record<KanbanColumn, string> = {
  ...
  declaracao_em_preenchimento: "border-t-blue-500",
...
const dotColors: Record<KanbanColumn, string> = {
  ...
  declaracao_em_preenchimento: "bg-blue-500",
